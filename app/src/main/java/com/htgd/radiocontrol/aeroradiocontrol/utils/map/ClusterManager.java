...
package com.htgd.radiocontrol.aeroradiocontrol.utils.map;
...
import com.htgd.radiocontrol.aeroradiocontrol.utils.map.algo.Algorithm;
import com.htgd.radiocontrol.aeroradiocontrol.utils.map.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.htgd.radiocontrol.aeroradiocontrol.utils.map.algo.PreCachingAlgorithmDecorator;
...
import com.htgd.radiocontrol.aeroradiocontrol.utils.map.view.ClusterRenderer;
import com.htgd.radiocontrol.aeroradiocontrol.utils.map.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void cluster() {
        ...
        try {
            // Attempt to cancel the in-fli  ght request.
