...
/**
 * Created by wzq on 2018/4/11.
 */

public class NetworkConnectChangedReceiver extends BroadcastReceiver{
    private HTIntfHandler htIntfHandler;
    ...
    public void onReceive(Context context, Intent intent) {
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())) {// 监听wifi的打开与关闭，与wifi的连接无关
           ...
           LogUtils.setLog("TAG", "wifiState:" + wifiState);
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                LogUtils.setLog("TAG", "isConnected:" + isConnected);
                     htIntf.release();
              /*  try {
                ...
                if(isConnected) {
                    EventBus.getDefault().post(new EventBusConnectString("网络连接"));
                }else{
                    EventBus.getDefault().post(new  EventBusConnectString("网络断开"));
                }
            }
        }
            ...
            if (info != null) {
                ...
                if (NetworkInfo.State.CONNECTED == info.getState() && info.isAvailable()) {
                    if (info.getType() == ConnectivityManager.TYPE_WIFI
                        ...
                        LogUtils.setLog("TAG", getConnectionType(info.getType()) + "连上");
                    }
                } else {
                    LogUtils.setLog("TAG", getConnectionType(info.getType()) + "断开");
                }
            }
        }
    }
