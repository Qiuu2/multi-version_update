...
public class AudioUtil {
     ...
     */
    public void setMediaVolume(int volume){//接听时的播放音量
         mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, volume,  AudioManager.FLAG_REMOVE_SOUND_AND_VIBRATE  );
         mAudioManager.setStreamVolume(AudioManager.STREAM_VOICE_CALL,volume,AudioManager.FLAG_REMOVE_SOUND_AND_VIBRATE);//设置对讲音量
    }
