...
> **当前状态(2026-05-11)**: 升级**完成** ✅
> - Pixel 10 Pro 模拟器(API 37 / Android 16)上 app 启动到登录页验证通过
> - R-001 已解决(htapplib 64-bit 移植到位)
> - R-006(百度地图 SDK 16 KB 兼容)已解决(升级到 v8.0.0)
> - 剩余唯一已知尾巴:htapplib 在物理 Pixel 7+ 设备上的 16 KB page 对齐
>   (模拟器靠 Berberis 翻译兜底,物理设备需要陶工的 16 KB 对齐重编版本)
> - 上线前必做项:**在公司内网用物理机做完整业务流程验收**(R-002)
