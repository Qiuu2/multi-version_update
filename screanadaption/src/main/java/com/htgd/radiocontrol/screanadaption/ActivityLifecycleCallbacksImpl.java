 ...
 */
package com.htgd.radiocontrol.screanadaption;
...
import static com.htgd.radiocontrol.screanadaption.AutoSizeConfig.DEPENDENCY_ANDROIDX;
import static com.htgd.radiocontrol.screanadaption.AutoSizeConfig.DEPENDENCY_SUPPORT;
...
public class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        if (AutoSizeConfig.getInstance().isCustomFragment()) {
            ...
            } else if (mFragmentLifecycleCallbacks != null && activity instanceof   androidx.fragment.app.FragmentActivity) {
                (( androidx.fragment.app.FragmentActivity) activity).getSupportFragmentManager().registerFragmentLifecycleCallbacks(mFragmentLifecycleCallbacks, true);
            }
        }
